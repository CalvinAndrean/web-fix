    ...
    methods: {
        ...
        cetakReport(item){
            if(item.payment_type == "Paket"){
                axios.get("http://127.0.0.1:8000/api/class_bookings/printReportDepositClass/" + item.id_class_booking)
                .then((response) => {
                ...
                axios.get("http://127.0.0.1:8000/api/class_bookings/printReportDepositCash/" + item.id_class_booking)
                .then((response) => {
                    this.report = response.data.data;
                    console.log(this.report);
                }).catch((error) => {
        ...
        insideClass(item){
            axios.get("http://127.0.0.1:8000/api/class_bookings/insideClass/" + item.id_class_running_daily)
            .then((response) => {

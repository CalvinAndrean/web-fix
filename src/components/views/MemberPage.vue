...
export default{
    ...
    methods: {
        ...
        makeMemberCard(item){
            ...
            axios.get("http://127.0.0.1:8000/api/members/" + item.id_member, {
            }).then((response) => {
        ...
        confirmSaveEdit(){
            ...
            axios.put("http://127.0.0.1:8000/api/members/" + this.id_member_edit, {
                email: email,
                password: password,
                birth_date: birth_date,
                fullname: fullname,
        ...
        printMemberCard(){
            axios.get("http://127.0.0.1:8000/api/members/membercard/" + this.id_member_card, {
            }).then((response) => {
                console.log(response);
        ...
        resetPassword(item){
            ...
            axios.put("http://127.0.0.1:8000/api/members/resetPassword/" + this.id_member_change, {
            }).then((response) => {
                console.log(response)
                this.getMembers();
            }).catch((error) => {
        ...
        confirmDelete(){
            ...
            axios.delete("http://127.0.0.1:8000/api/members/" + this.id_member_delete)
            this.cancelDelete()
        },
    },
    mounted(){

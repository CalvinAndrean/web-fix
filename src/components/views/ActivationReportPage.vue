...
export default{
    ...
    methods: {
        ...
        showReport(item){
            ...
            axios.get("https://calvin.ppcdeveloper.com/api/activation_reports/" + item.id_member)
            .then((response) => {
        ...
        confirmActivate(){
            if(this.expired_date >= new Date().toJSON().slice(0,10)){
                ...
                axios.post("https://calvin.ppcdeveloper.com/api/activation_reports/" + this.id_member, {
        ...
        cetakReport(item){
            if(item.expired_date != null){
                axios.get("https://calvin.ppcdeveloper.com/api/activation_reports/printReport/" + item.id_member, {
                }).then((response) => {
                    console.log(response);
        ...
        getActivationReport(){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/activation_reports")
            .then((response) => {
                this.activation_reports = response.data.data;
                console.log(this.activation_reports);
            }).catch((error) => {
        ...
        save() {
            ...
            axios.post("https://calvin.ppcdeveloper.com/api" + "/activation_reports", {
                id_member: id_member,
                id_pegawai: id_pegawai,
                datetime: datetime,
                expired_date: expired_date

    ...
    <v-main class="list">
        ...
        <v-card>
            <v-list-item>
                ...
                <v-list-item-content>
                    <v-list-item-title class="headline">Laporan Aktivitas Kelas Page</v-list-item-title>
                    <v-list-item-subtitle>Laporan Aktivitas Kelas</v-list-item-subtitle>
                </v-list-item-content>
            </v-list-item>
            <v-card-title>
                <v-text-field
        ...
        <v-card>
            <v-data-table :headers="headers" :items="laporan_aktivitas_kelas" :search="search">
            ...
            <v-card style="padding: 30px">
                ...
                <table style="border: 1px solid black;">
                    <tr>
                        ...
                        <th width="165px" style="border: 1px solid black; padding: 5px;">Total peserta</th>
                        <th width="165px" style="border: 1px solid black; padding: 5px;">Jumlah libur</th>
                    </tr>

                    <tr v-for="item in data_laporan.class_running" :key="item.month">
                        <td width="660px" style="border: 1px solid black; padding: 5px;">{{item.class_name}}</td>
                        <td width="660px" style="border: 1px solid black; padding: 5px;">{{item.fullname}}</td>
                        <td width="660px" style="border: 1px solid black; padding: 5px;">{{item.total_peserta}}</td>
...
export default{
    ...
    methods: {
        ...
        getLaporanAktivitasKelas(){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/laporan_aktivitas_kelas")
            .then((response) => {
        ...
        getData(item){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/laporan_aktivitas_kelas/" + item.id_laporan_aktivitas_kelas)
            .then((response) => {

...
export default{
    ...
    methods: {
        ...
        getClassRunningDailies(){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/class_running_dailiesAbsent")
            .then((response) => {
        ...
        confirmAdd(){
            ...
            axios.post("https://calvin.ppcdeveloper.com/api" + "/instructor_absents", {
        ...
        confirm(){
            ...
            axios.put("https://calvin.ppcdeveloper.com/api/instructor_absents/" + this.id_absent, {
        ...
        getInstructorAbsent(){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/instructor_absents")
            .then((response) => {

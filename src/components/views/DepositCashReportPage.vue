...
export default{
    ...
    methods: {
        ...
        showReport(item){
            axios.get("https://calvin.ppcdeveloper.com/api/deposit_cash_reports/" + item.id_member)
            .then((response) => {
        ...
        confirmDepo(){
            ...
            axios.post("https://calvin.ppcdeveloper.com/api/deposit_cash_reports/" + this.id_member, {
            ...
            // axios.put("https://calvin.ppcdeveloper.com/api/members/addDepo/" + this.id_member, {
        ...
        getDepositCashReport(){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/deposit_cash_reports")
            .then((response) => {
                this.deposit_cash = response.data.data;
                console.log(this.deposit_cash);
            }).catch((error) => {

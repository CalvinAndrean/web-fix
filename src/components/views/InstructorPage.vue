...
export default{
    ...
    methods: {
        confirmSaveAdd(){
            ...
            axios.post("http://127.0.0.1:8000/api" + "/instructors", {
                email: email,
                password: password,
                address: address,
                fullname: fullname,
        ...
        confirmSaveEdit(){
            ...
            axios.put("http://127.0.0.1:8000/api/instructors/" + this.id_instructor_edit, {
                email: email,
                password: password,
                address: address,
                fullname: fullname,
        ...
        confirmDelete(){
            ...
            axios.delete("http://127.0.0.1:8000/api/instructors/" + this.id_instructor_delete)
            this.cancelDelete()
        },
    },
    mounted(){

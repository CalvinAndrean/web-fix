...
export default{
    ...
    methods: {
        ...
        getLaporanPendapatanTahunan(){
            axios.get("http://127.0.0.1:8000/api" + "/laporan_pendapatan_tahunan")
            .then((response) => {
            ...
            axios.get("http://127.0.0.1:8000/api" + "/laporan_pendapatan_tahunan/2023")
            .then((response) => {
        ...
        getData(item){
            axios.get("http://127.0.0.1:8000/api" + "/laporan_pendapatan_tahunan/" + item.tahun)
            .then((response) => {
                this.item = item;

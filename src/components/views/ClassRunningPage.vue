...
export default{
    ...
    methods: {
        ...
        getClassDetails(){
            axios.get("https://calvin.ppcdeveloper.com/api" + "/class_details")
            .then((response) => {
        ...
        save() {
            ...
            axios.post("https://calvin.ppcdeveloper.com/api" + "/class_runnings", {
        ...
        saveEdit(){
            ...
            axios.put("https://calvin.ppcdeveloper.com/api/class_runnings/" + this.id_class_running_edit, {
                id_instructor: id_instructor,
                id_class: id_class,
                start_time: start_time,
                end_time: end_time,
